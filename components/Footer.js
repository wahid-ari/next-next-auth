		...
		<footer className="text-gray-600 body-font">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pt-10 pb-4 flex items-center sm:flex-row flex-col">
				...
				<span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
					<a href="#" aria-label="Facebook" className="text-gray-500 dark:text-white">
						<svg
							fill="currentColor"
							strokeLinecap="round"
					...
					<a href="#" aria-label="Twitter" className="ml-3 text-gray-500 dark:text-white">
						<svg
							fill="currentColor"
							strokeLinecap="round"
							strokeLinejoin="round"
					...
					<a href="#" aria-label="Instagram" className="ml-3 text-gray-500 dark:text-white">
						<svg
							fill="none"
							stroke="currentColor"
							strokeLinecap="round"
					...
					<a href="#" aria-label="Linkedin" className="ml-3 text-gray-500 dark:text-white">
						<svg
							fill="currentColor"
							stroke="currentColor"
							strokeLinecap="round"
